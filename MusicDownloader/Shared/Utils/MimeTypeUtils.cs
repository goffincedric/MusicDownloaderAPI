...
{
    private static readonly Dictionary<string, string> MimeTypeMapping =
    ...
    public static string MapMimeTypeToExtension(string mimeType)
    {
        ...
        throw new MusicDownloaderException(
            $"Unmapped mime type: {mimeType}",
            ErrorCodes.UnmappedMimeType,
    ...
    public static string MapExtensionToMimeType(string fileExtension)
    {
        ...
        // Else, throw error
        throw new MusicDownloaderException(
            $"Unmapped file extension: {fileExtension}",
            ErrorCodes.UnmappedFileExtension,
            HttpStatusCode.InternalServerError
        );
    }
}
